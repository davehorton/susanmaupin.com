jQuery( function($){
	...
	function setNavbarLight() {
		...
		$('.navbar-brand img').attr('src', 'assets/img/maupin/maupin-signature.png');
	}

	function setNavbarTransparent() {
		$('.navbar').removeClass('navbar-light');
		$('.navbar-brand img').attr('src', 'assets/img/maupin/maupin-signature-white.png');
	}
	...
	if( $('.slideshow').length > 0 ) {
		$.supersized({
			...
			slides:  	[				// Slideshow Images
							{image : 'assets/img/maupin/himalayas.jpg', title : '<div class="hero-text"><h2 class="hero-heading">INNOVATIVE MARKETING LEADERSHIP</h2><p>Helping you scale new heights</p></div>', thumb : '', url : ''},
	...
	// 	if($.browser.mobile) {
	// 		$(".hero-video").addClass('no-video-bg');
	// 	}
	// }
